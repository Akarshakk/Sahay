...
mixin _$IncidentModel {
  ...
  SeveritLevel get severity => throw _privateConstructorUsedError;
...
abstract class _IncidentModel implements IncidentModel {
  const factory _IncidentModel(
      ...
      required final SeveritLevel severity,
